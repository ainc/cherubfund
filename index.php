...
<!-- Animation CSS -->
<link href="_include/css/animations.css" rel="stylesheet">
        	...
        	<ul>
                ...
                <li data-transition="random" data-slotamount="1" data-masterspeed="300">
            		...
            		<div class="caption very_big_custom_text lfl stl"
                         ...
                         data-y="255"
                         data-speed="300"
                         data-start="900">CHERUB FUND</div>

                    <div class="caption custom_text lfl stl"
                         data-x="center"
                         data-y="324"
                         data-speed="300"
                         data-start="1000"><span class="color-text">PROVIDING ENTREPRENEURS</span></div>
                         
                     <div class="caption custom_text_link lfl stl"
                         data-x="center"
                         data-y="379"
                         data-speed="300"
                         data-start="1200"><span class="color-text">WITH THE FOUNDATION THEY NEED</span></div>
                </li>
        </div>
    </div>
</section>
...
<section id="intro-box" class="margin-80">
	<div class="container">
    	<div class="row">
        	<div class="span12">
            	<h3>We do our best to be an entrepreneur friendly investment group. Most of the members of the group are entrepreneurs themselves.</h3>
...
<section id="about-section" >
	<div class="container" id="about">
        ...
        <div class="margin-80">
            <!-- Start image Block -->
            <div class="span6" style="padding-bottom: 40px;">
            	<img src="_include/img/about_feature.jpg" style="height: auto; width: 100%;" alt="Image">
            </div>
            <!-- End Image Block -->
	...
	<div class="container">
        ...
        <a class="box" href="#">
                  <div class="icon">
                    ...
                    <h4>Be Entreprenuer Friendly</h4>
          ...
          <a class="box" href="#">
                  <div class="icon">
                      <i class="font-icon-fire"></i>
                    </div>
                    <h4>Invest Often and Quickly</h4>
                    <p>The fund will make 6 investments over the course of the first year. We make deals within 2-3 weeks of conideration and can tell within 2 meetings if we want to work with a company or not.</p>
                </a>
			</div>
			<div class="span4">
           <a class="box" href="#">
                  <div class="icon">
                      <i class="font-icon-file"></i>
                    </div>
                    <h4>Keep Everything Simple</h4>
...
<section class="margin-80">
	<div class="container">
        ...
        <br></br>
        <br></br>
				<h4>Interested in working with the Cherub Fund?</h4><br>
        <a class="button-main" href="#">Contact Us</a>
        <a class="button-main" href="http://cherubfund.org/entre.php">Learn More</a>
			</div>
		</div>
	</div>
</section>
